...
class PlaneDetection():
    ...
    def segment(self, distance_threshold=0.09, ransac_n=3, num_iterations=800):
...
def main():
    ...
    point_cloud_original = o3d.io.read_point_cloud('Scenes_pcd/01.pcd')
    ...
    pcd_objects = table_plane.segment(distance_threshold = 0.005, ransac_n = 3 , num_iterations = 100) #has objects and table boundaries
